package com.sunlotus.wechat.service;
...
public class WechatService { 
	...
	private void init() {
		...
		wxMpConfigStorage.setAppId("wx273ea9b350cea64b"); // 设置微信公众号的appid
		wxMpConfigStorage.setSecret("4d9151b5ed5211ebd10948ee36eceee4"); // 设置微信公众号的app
																			// corpSecret
		wxMpConfigStorage.setToken("lixiangqian"); // 设置微信公众号的token
